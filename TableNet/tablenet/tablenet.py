...
from torchvision.models import vgg19, vgg19_bn, resnet18, resnet34, resnet50
    ...
    def configure_optimizers(self):
        ...
        scheduler = {
            'scheduler': optim.lr_scheduler.OneCycleLR(optimizer,
                                                       max_lr=0.001, steps_per_epoch=230, epochs=120, pct_start=0.1),
            'interval': 'step',
        }
...
class TableNet(nn.Module):
    ...
    def __init__(self, num_class: int, batch_norm: bool = False):
        ...
        self.modules = list(self.resnet18.children())[:-2]      # delete the last fc layer.
        self.resnet = nn.Sequential(*self.modules)
        self.layers = [5, 6]
        # self.layers = [25, 37]
        # self.resnet34 = resnet34(pretrained=True).features
        # self.layers = [40, 72]
        # self.resnet50 = resnet50(pretrained=True).features
        # self.layers = [56, 100]
...
class ColumnDecoder(nn.Module):
    ...
    def __init__(self, num_classes: int):
        ...
        # self.layer = nn.ConvTranspose2d(1280, num_classes, kernel_size=2, stride=2, dilation=1)   # use for vgg19
        self.layer = nn.ConvTranspose2d(896, num_classes, kernel_size=2, stride=2, dilation=1)
